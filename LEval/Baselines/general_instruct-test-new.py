...
def main():
    ...
    for file_name in key_data_pairs:
        ...
        for d in tqdm(data):
            ...
            for inst, out in zip(instructions, outputs):
                ...
                if model.config.model_type in ("llama", "mistral"):
                    ...
                    raise NotImplementedError("Specify the end token for the model")
                    
                save_d[f'{open_source_model}_pred'] = output.replace(end_token, '')
        ...
        script = f"python Evaluation/auto_eval.py --pred_file {file_name}"
...
if __name__ == "__main__":
    ...
    open_source_model = args.save_name + "-" + args.max_length
    if args.ntk_alpha > 1:
