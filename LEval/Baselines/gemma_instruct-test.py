    ...
    for file_name in key_data_pairs:
        ...
        for d in tqdm(data):
            ...
            for inst, out in zip(instructions, outputs):
                ...
                if "codeU" in file_name:
                    ...
                    for dd in document.split("Question: "):
                        if dd: # skip the "" case
                            ...
                            conv.append_message(conv.roles[0], "Question: " + question + "Let's think step by step")
                ...
                save_d[f'{open_source_model}_pred'] = output.replace('<end_of_turn><eos>', '')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--scale', default='9b', choices=['9b', '27b'])
    ...
    model_path = f"google/gemma-2-{args.scale}-it"    
    open_source_model = f"gemma-2-{args.scale}-instruct-" + args.max_length
    if args.ntk_alpha > 1:
