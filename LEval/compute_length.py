...
# -*- coding:utf-8 -*-
import argparse
from Baselines.llama_flash_attn_monkey_patch import replace_llama_attn_with_flash_attn
...
def main():
    ...
    for file_name in key_data_pairs:
        ...
        print(file_name, np.mean(sample_lengths))
        
        
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--metric', default="exam_eval",
    ...
    parser.add_argument('--scale', default='8B', choices=['8B', '70B'])
    ...
    model_path = f"meta-llama/Meta-Llama-3-{args.scale}-Instruct"
    open_source_model = f"llama3-{args.scale}-instruct-" + args.max_length
    if args.ntk_alpha > 1:
